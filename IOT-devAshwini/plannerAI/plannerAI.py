...
plannerNewInitState = {}
file = '/home/bhaskar/IOT/IOT/IOT-devAshwini/dataBase/room01DB.csv'
...
def generateProblemFile( objectTypes, init, goal):
	with open('/home/bhaskar/IOT/IOT/IOT-devAshwini/plannerAI/problem_template_empty.txt') as f:
		newText=f.read()
	...
	with open('/home/bhaskar/IOT/IOT/IOT-devAshwini/plannerAI/Problem_generated.pddl', "w") as f:
		f.truncate()
		f.write(newText)

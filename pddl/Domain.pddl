(define (domain SMSDomainFile)
    ...
    (:predicates
        ...
        ;;for person
        (isInformedDate ?x - person ?e - equipment)
        (isInformedBadEqu ?x - person ?e - equipment)
        (isInformedQuality ?x - person ?s - qualitySensor )
        (isInformedLogistics ?x - person ?s - pressure)

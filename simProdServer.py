...
def GetAIPlan(clientName):
    data = {'domain': open("/home/ashwini/Desktop/IOT/plannerAI/Domain.pddl", 'r').read(),
    'problem' : open("/home/ashwini/Desktop/IOT/plannerAI/Problem_generated.pddl", 'r').read()}
    response = requests.post('http://solver.planning.domains/solve', json = data).json()

    with open('/home/ashwini/Desktop/IOT/plannerAI/AIPlan.txt', "w") as f:
      f.truncate()
